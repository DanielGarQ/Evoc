...
import co.edu.uco.evoc.crosscutting.exception.EvocCrossCuttingException;
import co.edu.uco.evoc.crosscutting.utils.Messages.UtilSqlMessages;
...
public class UtilSql {
	...
	public static boolean connectionIsOpen(final Connection connection) {
		if (UtilObject.isNull(connection)) {
			...
			throw EvocCrossCuttingException.create(technicalMessage, userMessage);
		}
		try {
			...
			throw EvocCrossCuttingException.create(technicalMessage, userMessage, exception);
	...
	public static void closeConnection(final Connection connection) {
		...
		}catch(EvocCrossCuttingException exception) {
			throw exception;
